...
class PantallaAreasComunes extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Áreas Comunes')), backgroundColor: Colors.white,
      body: SafeArea(child: SingleChildScrollView(padding: const EdgeInsets.all(16.0),
          child: Column(crossAxisAlignment: CrossAxisAlignment.start,

            children: [
              Text('Elige un área para reservar', style: GoogleFonts.inter(color: Colors.black54, fontSize: 14,),),
                ...
                return Padding(padding: const EdgeInsets.only(bottom: 16),
                  child: Material(color: Colors.transparent, borderRadius: BorderRadius.circular(8),
                    ...
                    child: InkWell(
                      ...
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) => PantallaReservarHorario(area: area['nombre'] as String,),),);
                      },
                      ...
                      child: Ink(
                        ...
                        child: Row(
                          children: [Icon(area['icono'] as IconData, color: Colors.green.shade700, size: 32,),
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  Text(area['nombre'] as String, style: GoogleFonts.inter(fontSize: 16, fontWeight: FontWeight.bold,),),
                                  const SizedBox(height: 4),

                                  Text('Toca para reservar', style: GoogleFonts.inter(fontSize: 13, color: Colors.black54,),),
                                ],
                              ),
                            ),
              ...
              SizedBox(
                width: double.infinity, child: OutlinedButton.icon(
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => const PantallaMisReservas(),),);
                  },

                  icon: Icon(Icons.event_note, color: Colors.green.shade700),
                  label: Text('Ver Mis Reservas', style: GoogleFonts.inter(color: Colors.green.shade700, fontSize: 15, fontWeight: FontWeight.bold,),),
