          ...
          child: Container(width: double.infinity, padding: const EdgeInsets.all(24),
            ...
            child: Column(mainAxisAlignment: MainAxisAlignment.center,
              ...
              children: [
                ...
                Text('RESERVA CONFIRMADA', textAlign: TextAlign.center, style: GoogleFonts.inter(color: Colors.black, fontSize: 22, fontWeight: FontWeight.bold,),),
                const SizedBox(height: 40),

                Text(area.toUpperCase(), textAlign: TextAlign.center, style: GoogleFonts.inter(color: Colors.black, fontSize: 18, fontWeight: FontWeight.bold,),),
                ...
                SizedBox(
                  width: double.infinity, child: OutlinedButton(
                    onPressed: () {
                      Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => const PantallaAreasComunes(),), (route) => route.isFirst,);
                    },
                    ...
                    child: Text('Volver a Áreas Comunes', style: GoogleFonts.inter(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold,),),
                  ),
                ),
              ],
            ),
